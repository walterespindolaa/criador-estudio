-- ============================================================
-- A SOCIAL MIDIA ABRE O CARD DO PARCEIRO (Walter, 20/09/2026)
--
-- "Quando clica no post dentro de Com parceiros precisa abrir aquela janela
-- em sincronia com a do designer, e nao la dentro do cliente." A janela do
-- designer nasce de parceiro_abrir_card, que so deixava o proprio parceiro
-- entrar. Aqui a agencia dona do post (e quem age por ela, via acts_for)
-- tambem pode LER o card. So leitura: as acoes (marcar, entregar, sugerir
-- prazo) continuam com a checagem do parceiro.
--
-- Corpo copiado de 20260915000001_comentario_ancorado.sql, que e a versao
-- que esta no banco; a unica mudanca e a checagem de acesso. Idempotente.
-- ============================================================
