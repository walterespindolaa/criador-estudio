-- Página pública do cronograma passa a devolver a COR e a LOGO do próprio cliente
-- (definidas na ficha do cliente). Assim um cliente homem não recebe o rosa da
-- agência, e a logo dele aparece ao lado da logo da agência.
...
begin
  ...
  -- Cor e logo do cliente (via external_clients -> crm_clients).
