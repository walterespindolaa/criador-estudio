          ...
          <div className="space-y-5 mt-2">
            ...
            <Sec title="Escopo dos serviços">
              <Grid>
                ...
                <Fld label="Publicações/mês"><Input type="number" inputMode="numeric" value={d.postsPerMonth} onChange={(e) => set({ postsPerMonth: Number(e.target.value) })} className="rounded-xl" /></Fld>
                <Fld label="Carrosséis"><Input type="number" inputMode="numeric" value={d.carrosseis} onChange={(e) => set({ carrosseis: Number(e.target.value) })} className="rounded-xl" /></Fld>
                <Fld label="Vídeos"><Input type="number" inputMode="numeric" value={d.videos} onChange={(e) => set({ videos: Number(e.target.value) })} className="rounded-xl" /></Fld>
                ...
                <Fld label="Reuniões/mês"><Input type="number" inputMode="numeric" value={d.meetings} onChange={(e) => set({ meetings: Number(e.target.value) })} className="rounded-xl" /></Fld>
            ...
            <Sec title="Preço e prazo">
              <Grid>
                ...
                <Fld label="Dia de vencimento"><Input type="number" inputMode="numeric" value={d.dueDay} onChange={(e) => set({ dueDay: Number(e.target.value) })} className="rounded-xl" /></Fld>
