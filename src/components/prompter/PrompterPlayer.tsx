...
function PrompterPlayerInner({ title, text, onExit }: Props) {
  ...
  useEffect(() => {
    ...
    function readVoiceLevel(): number {
      ...
      // TS 5.8 tipa Uint8Array como Uint8Array<ArrayBufferLike>; a DOM lib espera
      // Uint8Array<ArrayBuffer>. O buffer aqui é sempre ArrayBuffer concreto.
      micAnalyser.getByteTimeDomainData(vadBuf as unknown as Uint8Array<ArrayBuffer>);
      let sum = 0;
