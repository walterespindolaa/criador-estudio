      ...
      <Dialog open={expandOpen} onOpenChange={(o) => !expanding && setExpandOpen(o)}>
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <Input type="number" inputMode="numeric" min={3} max={50} value={expandSeats} onChange={(e) => setExpandSeats(Math.max(3, Math.min(50, Number(e.target.value) || 3)))} disabled={expanding} className="rounded-xl w-24" />
